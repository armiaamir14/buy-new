...
import 'package:buy_now/services/store.dart';
import 'package:buy_now/widgets/productView.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:curved_navigation_bar/curved_navigation_bar.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:flutter/material.dart';
import 'package:buy_now/services/auth.dart';
          ...
          child: Scaffold(
            ...
            bottomNavigationBar: CurvedNavigationBar(
              ...
              onTap: (index) async {
                switch (index) {
                  case 0:
                    ...
                    break;
                  case 1:
                    return Navigator.pushNamed(context, CartScreen.id);
                    break;
                  case 2:
              ...
              items: [
                ...
                Icon(Icons.add_shopping_cart, color: kMainColor),
                Icon(Icons.close, color: kMainColor),
              ],
            ),
            body: PageView(
              onPageChanged: (index) {
